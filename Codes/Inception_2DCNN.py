...
from keras.layers import Activation, Flatten, Dropout, Dense, Input, BatchNormalization, concatenate
...
class Inception:
    ...
    def Inception_v3(self):
        ...
        if self.auxilliary_outputs:
            # Auxilliary Output 0
            aux_pool = AveragePooling2D(pool_size=(5, 5), strides=(3, 3), padding='valid')(x)
    ...
    def Inception_v4(self):
        ...
        branch2 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2))(x)
